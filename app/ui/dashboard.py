...
# Resolve project root (two levels up from app/ui/)
...
from app.services.tracker       import (log_prediction, evaluate_predictions,
                                         get_accuracy_stats, get_model_memory,
                                         load_predictions, print_prediction_report,
                                         get_asset_type, get_asset_icon)
from app.services.scorer        import score_ticker, score_all_tickers
from app.services.watchlist     import get_top_tickers, save_watchlist
from app.services.contradictions import detect_contradictions
from app.services.sectors       import build_rotation_data, get_sector_summary
from app.services.trends        import detect_trending_tickers
from app.services.backtester    import run_backtest, get_backtest_summary
from config import COMMODITY_KEYWORDS, ETF_TICKERS
